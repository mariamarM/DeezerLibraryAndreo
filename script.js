...
//aqui empieza la vaina de la busqueda de las canciones hay q comentarla cuando estas en registros
  ...
  //   const nombre = document.getElementById("nombreBanda").value.trim(); 
  //   const resultado = document.getElementById("cancionesDeezer");
  //   resultado.textContent = ""; 
  
  //   if (nombre === "") {
  //     resultado.style.color = "red";
  //     resultado.textContent = "⚠️ Write the name of the band or artist.";
  //     return;
  //   }
        ...
        resultado.innerHTML = resultados
          ...
          audios.forEach((audio) => {
            audio.addEventListener("play", () => {
              ...
              alert(" Song has been saved", cancionReproducida);
            });
          });
      })
      .catch((error) => {
